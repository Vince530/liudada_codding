...
LOCAL_HEADER_LIBRARIES += libcutils_headers libcameracustom.flashlight_headers
#-----------------------------------------------------------
...
################################################################################
#       libcameracustom.flashlight_headers
################################################################################
include $(CLEAR_VARS)
...
#For BuildInTypes.h
LOCAL_EXPORT_C_INCLUDE_DIRS += $(MTK_PATH_SOURCE)/hardware/mtkcam/include/mtkcam/def
...
LOCAL_EXPORT_C_INCLUDE_DIRS += $(TOP)/$(MTK_PATH_COMMON)/hal/flashlight
LOCAL_EXPORT_C_INCLUDE_DIRS += $(TOP)/$(MTK_PATH_CUSTOM_PLATFORM)/hal/flashlight
...
#-----------------------------------------------------------
LOCAL_MODULE := libcameracustom.flashlight_headers
LOCAL_MODULE_OWNER := mtk
