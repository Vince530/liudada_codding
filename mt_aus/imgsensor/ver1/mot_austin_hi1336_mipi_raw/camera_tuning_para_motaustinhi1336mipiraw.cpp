...
#include "camera_AE_Sync_param_motaustinhi1336mipiraw.h"
#include "camera_AWB_Sync_param_motaustinhi1336mipiraw.h"
#include "camera_AWB_Stat_param_motaustinhi1336mipiraw.h"
#include "camera_info_motaustinhi1336mipiraw.h"
...
#include "motaustinhi1336mipiraw_Info.h"
...
#include INCLUDE_FILENAME_ISP_TONEMAP_PARAM
    ...
    DngMetadata:
    {
        ...
        3,  //i4RefereceIlluminant2
        {
            // rNoiseProfile[4]
            {
                {1.7278773179522054e-06, -4.908092503543102e-06},
                {1.2408131437046072e-11, 2.077752732626174e-07},
            },
            {
                {1.7171614799913716e-06, 1.1560280914292178e-06},
                {1.1876202358541253e-11, 1.39591252433679e-07},
            },
            {
                {1.7116489021626295e-06, 4.3759099379675534e-07},
                {1.3738664272156561e-11, 9.810140376643709e-08},
            },
            {
                {1.670370581838046e-06, -2.390561697058558e-06},
                {1.5673243226981443e-11, 1.7817467388435404e-07},
            },
        },
    }
}};
