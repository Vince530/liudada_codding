...
//
//
#define LOG_TAG "motaustinhi1336mipiraw"
...
#include "camera_AE_PLineTable_motaustinhi1336mipiraw.h"
...
static void get_flicker_para_by_Preview_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L60 = {784, 592, 1107, -484};
    FLICKER_CUST_STATISTICS EV60_L50 = {1088, 536, 1417, -520};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1402;
...
static void get_flicker_para_by_Preview_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {746, 623, 1163, -497};
    FLICKER_CUST_STATISTICS EV60_L50 = {1086, 537, 1419, -520};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1612;
...
static void get_flicker_para_by_Capture_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {1412, 413, 1091, -453};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1382;
...
static void get_flicker_para_by_Video_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {990, 469, 877, -424};
    FLICKER_CUST_STATISTICS EV60_L50 = {1277, 457, 1207, -479};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Video_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 110, 120, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1002, 463, 866, -421};
    FLICKER_CUST_STATISTICS EV60_L50 = {1215, 480, 1269, -492};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1606;
...
static void get_flicker_para_by_Video2_Bin1(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {233, 1992, 3721, -794};
    FLICKER_CUST_STATISTICS EV60_L50 = {554, 1054, 2783, -693};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Video2_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {517, 1129, 2981, -710};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1646;
...
static void get_flicker_para_by_Custom1_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {967, 480, 898, -431};
    FLICKER_CUST_STATISTICS EV60_L50 = {1180, 494, 1305, -499};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1387;
    para->flickerSearchRange = 28;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
...
{
    int freq[9] = {70, 80, 100, 120, 130, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {924, 502, 939, -442};
    FLICKER_CUST_STATISTICS EV60_L50 = {1126, 518, 1369, -511};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1606;
...
static void get_flicker_para_by_Custom2_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {649, 716, 1338, -533};
    FLICKER_CUST_STATISTICS EV60_L50 = {656, 890, 2350, -649};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Custom2_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 80, 100, 120, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {576, 806, 1507, -563};
    FLICKER_CUST_STATISTICS EV60_L50 = {649, 898, 2372, -652};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1620;
    para->flickerSearchRange = 8;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
