...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0065)
...
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0091)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0091)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0026)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0026)
#define AKS_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, AKS_0065)
...
#define CNR_CCR_ISP_Other_BASE                                       M_CONC(TARGET_SENSOR, CNR_CCR_0039)
#define CNR_ABF_ISP_Other_BASE                                       M_CONC(TARGET_SENSOR, CNR_ABF_0039)
