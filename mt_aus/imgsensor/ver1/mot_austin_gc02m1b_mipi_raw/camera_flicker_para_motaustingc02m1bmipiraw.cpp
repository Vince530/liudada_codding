//[Sensor]
//name = motaustingc02m1bmipiraw
//bin_ratio = 1,2
//
//[Preview]
//read_freq = 1533000000
//pixel_line = 7872
//column_length = 2975
//
//[Capture]
...
//
//[Custom1]
//read_freq = 1728000000
//pixel_line = 5376
//column_length = 1055
//
//[Custom2]
//read_freq = 1152000000
//pixel_line = 7872
//column_length = 2135
//
//[Custom3]
//read_freq = 1689600000
//pixel_line = 9440
//column_length = 5975
//
//[Custom4]
...
//pixel_line = 5376
//column_length = 695
#define LOG_TAG "motaustingc02m1bmipiraw"
...
static void get_flicker_para_by_Preview_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    para->flickerGradThreshold = 1324;
...
static void get_flicker_para_by_Capture_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {1265, 461, 1218, -481};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Capture_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1049, 443, 828, -410};
    FLICKER_CUST_STATISTICS EV60_L50 = {1251, 466, 1232, -484};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1503;
    para->flickerSearchRange = 24;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Video_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {1324, 441, 1164, -470};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1336;
...
static void get_flicker_para_by_Video_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {1255, 465, 1227, -483};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Video1_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {294, 1581, 2953, -735};
    FLICKER_CUST_STATISTICS EV60_L50 = {350, 1665, 4395, -810};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Video1_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {100, 120, 130, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {290, 1600, 2988, -738};
    FLICKER_CUST_STATISTICS EV60_L50 = {346, 1685, 4448, -813};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Video2_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {80, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1115, 416, 778, -394};
    FLICKER_CUST_STATISTICS EV60_L50 = {1330, 439, 1158, -468};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1468;
    para->flickerSearchRange = 16;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Custom1_Bin1(FLICKER_CUST_PARA* para)
{
    int freq[9] = {100, 120, 130, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {128, 3617, 6757, -947};
    FLICKER_CUST_STATISTICS EV60_L50 = {153, 3810, 10058, -1022};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1332;
    para->flickerSearchRange = 16;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Custom1_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {100, 120, 130, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {121, 3842, 7177, -963};
    FLICKER_CUST_STATISTICS EV60_L50 = {144, 4047, 10684, -1037};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Custom2_Bin1(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {907, 512, 957, -447};
    FLICKER_CUST_STATISTICS EV60_L50 = {1082, 539, 1425, -521};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1328;
    para->flickerSearchRange = 36;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Custom2_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {899, 517, 966, -449};
    FLICKER_CUST_STATISTICS EV60_L50 = {1072, 544, 1438, -524};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1409;
    para->flickerSearchRange = 16;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Custom3_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {885, 525, 981, -453};
    FLICKER_CUST_STATISTICS EV60_L50 = {1056, 553, 1460, -528};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1321;
    para->flickerSearchRange = 100;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
    para->EV50_L60 = EV50_L60;
...
static void get_flicker_para_by_Custom3_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 90, 100, 110, 120, 140, 160, 190, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {876, 530, 991, -456};
    FLICKER_CUST_STATISTICS EV60_L50 = {1045, 559, 1475, -530};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1367;
    para->flickerSearchRange = 48;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Custom4_Bin1(FLICKER_CUST_PARA* para)
{
    int freq[9] = {100, 120, 130, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {48, 9650, 18025, -1198};
    FLICKER_CUST_STATISTICS EV60_L50 = {57, 10164, 26831, -1273};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1343;
    para->flickerSearchRange = 8;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Custom4_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {100, 120, 130, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {44, 10488, 19589, -1220};
    FLICKER_CUST_STATISTICS EV60_L50 = {52, 11046, 29159, -1294};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1405;
