...
#include "camera_AE_PLineTable_motaustingc02m1bmipiraw.h"
#include "camera_AE_Sync_param_motaustingc02m1bmipiraw.h"
#include "camera_AWB_Sync_param_motaustingc02m1bmipiraw.h"
#include "camera_AWB_Stat_param_motaustingc02m1bmipiraw.h"
#include "camera_info_motaustingc02m1bmipiraw.h"
...
#include "motaustingc02m1bmipiraw_Info.h"
...
#include INCLUDE_FILENAME_ISP_TONEMAP_PARAM
    ...
    DngMetadata:
    {
        ...
        3,  //i4RefereceIlluminant2
        {
            // rNoiseProfile[4]
            {
                {5.77547229817e-7, -1.69181587226e-5},
                {1.08899083268e-12, 4.54880790446e-7},
            },
            {
                {6.15468455528e-7, 1.76011708762e-6},
                {8.86214337534e-13, 3.02959625747e-7},
            },
            {
                {3.15079797422e-7, -1.48263996116e-6},
                {4.51437301535e-13, 3.81632523581e-7},
            },
            {
                {3.5141142611e-7, -3.42618401692e-6},
                {4.85899020891e-13, 3.35022735379e-7},
            },
        },
    }
}};
