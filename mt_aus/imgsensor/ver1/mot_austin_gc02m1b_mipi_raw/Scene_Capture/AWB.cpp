...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB gain of AWB light source
            {
                ...
                // HORIZON
                {
                     ...
                     547, // AWBGAIN_HORIZON_G
                    1921  // AWBGAIN_HORIZON_B
                },
                // A
                {
                     589, // AWBGAIN_A_R
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                    -242, // TUNGSTEN RightBound
                    -748, // TUNGSTEN LeftBound
                    -356, // TUNGSTEN UpperBound
                    -461  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                    -242, // WARM FLUORESCENT RightBound
                    -895, // WARM FLUORESCENT LeftBound
                    -461, // WARM FLUORESCENT UpperBound
                    -611  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                     -61, // FLUORESCENT RightBound
                    -242, // FLUORESCENT LeftBound
                    -386, // FLUORESCENT UpperBound
                    -500  // FLUORESCENT LowerBound
                },
                // CWF
                {
                     -54, // CWF RightBound
                ...
                // DAYLIGHT
                {
                     109, // DAYLIGHT RightBound
                     -61, // DAYLIGHT LeftBound
                    -386, // DAYLIGHT UpperBound
                    -500  // DAYLIGHT LowerBound
                },
                // SHADE
                {
                     255, // SHADE RightBound
                     109, // SHADE LeftBound
                    -386, // SHADE UpperBound
                    -476  // SHADE LowerBound
                },
                // DF
                {
                     109, // DF RightBound
    ...
    /******************************************************************************/
            ...
            // PWB light area
            {
                ...
                // CLOUDY_D
                {
                     234, // CLOUDY_D RightBound
                      59, // CLOUDY_D LeftBound
                    -386, // CLOUDY_D UpperBound
                    -500  // CLOUDY_D LowerBound
                },
                // SHADE
                {
                     334, // SHADE RightBound
                      59, // SHADE LeftBound
                    -386, // SHADE UpperBound
                    -500  // SHADE LowerBound
                },
                // TWILIGHT
                {
                     -61, // TWILIGHT RightBound
                    -221, // TWILIGHT LeftBound
                    -386, // TWILIGHT UpperBound
                    -500  // TWILIGHT LowerBound
                },
                // FLUORESCENT
                {
                     129, // FLUORESCENT RightBound
                    -270, // FLUORESCENT LeftBound
                    -396, // FLUORESCENT UpperBound
                    -571  // FLUORESCENT LowerBound
                },
                // WARM FLUORESCENT
                {
                    -251, // WARM FLUORESCENT RightBound
                    -451, // WARM FLUORESCENT LeftBound
                    -396, // WARM FLUORESCENT UpperBound
                    -571  // WARM FLUORESCENT LowerBound
                },
                // INCANDESCENT
                {
                    -251, // INCANDESCENT RightBound
                    -451, // INCANDESCENT LeftBound
                    -386, // INCANDESCENT UpperBound
                    -500  // INCANDESCENT LowerBound
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
            // PWB default gain
            {
                ...
                // FLUORESCENT
                {
                     906, // PWB_FLUORESCENT_R
                     512, // PWB_FLUORESCENT_G
                    1074  // PWB_FLUORESCENT_B
                },
                // WARM FLUORESCENT
                {
                     623, // PWB_WARM FLUORESCENT_R
                     512, // PWB_WARM FLUORESCENT_G
                    1580  // PWB_WARM FLUORESCENT_B
                },
                // INCANDESCENT
                {
                     590, // PWB_INCANDESCENT_R
                     512, // PWB_INCANDESCENT_G
                    1497  // PWB_INCANDESCENT_B
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
                // Rotated X coordinate
                {
                    ...
                    -249,  // RotatedXCoordinate2
                     -88,  // RotatedXCoordinate3
    ...
    /******************************************************************************/
            // Preference gain for each light source
            {
                ...
                { // DAYLIGHT
                    ...
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {506, 512, 506}, {502, 512, 506}, {502, 512, 506}, {502, 512, 506}, {502, 512, 506}, {502, 512, 512}, {502, 512, 512}, {502, 512, 512}
                },
                { // SHADE
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512},
    ...
    /******************************************************************************/
            // AWB daylight locus probability (Statistic Weighting) look-up table (Max: 100; Min: 0)
            {
                ...
                {{  95,  95,  95,  95,  95,  95,  95,  88,  88,  90,  90,  90, 100, 100, 100, 100, 100,  75,  50,  25,   0,   0,   0}}, // TUNGSTEN
                {{  95,  95,  95,  95,  95,  95,  95,  88,  88,  90,  90,  90, 100, 100, 100,  75,  50,  25,  25,  25,   0,   0,   0}}, // WARM FLUORESCENT
                {{  92,  92,  92,  92,  92,  92,  92,  88,  88,  88,  89,  90,  94,  98,  95,  75,  50,  25,  25,  25,   0,   0,   0}}, // FLUORESCENT
                {{  90,  90,  90,  90,  75,  75,  75,  75,  75,  75,  75,  80,  86,  90,  82,  55,  30,  30,  30,  30,   0,   0,   0}}, // CWF
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  85,  65,  50,  35,  30,  20}}, // DAYLIGHT
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  75,  40,  20,   0,   0,   0,   0}}, // SHADE
    ...
    /******************************************************************************/
            // AWB Light source probability (P1) look-up table (Max: 100; Min: 0)
            {
                ...
                {{  50,  50,  50,  50,  50,  50,  50,  50,  50,  50,  80,  75,  70,  70,  75,  80,  60,  30,   1,   1,   1,   1,   1}}, // TUNGSTEN
                {{  50,  50,  50,  50,  50,  50,  50,  50,  50,  50,  80,  75,  70,  70,  75,  80,  60,  30,   1,   1,   1,   1,   1}}, // WARM FLUORESCENT
                {{  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  92,  93,  93,  95,  95,  95,  80,  60,  60,  60,  60,  60,  60}}, // FLUORESCENT
    ...
    /******************************************************************************/
                //Daylight locus offset LUTs
                {
                    { // TUNGSTEN
                        {   0,  500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000},
                        {   0,  200,  400,  600, 1200, 1500, 1889, 2011, 2333, 2556, 2778, 3000, 3222, 3444, 3667, 3889, 4111, 4333, 4556, 4778, 5000}
                    },
                    { // WARM FLUORESCENT
                        {   0,  500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000},
                        {   0,  350,  600,  800, 1244, 1567, 1889, 1911, 2233, 2556, 2778, 3000, 3222, 3444, 3667, 3889, 4111, 4333, 4556, 4778, 5000}
                    },
                    { // SHADE
                        {   0,  500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000},
                        {   0,  600, 1250, 1800, 2200, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000}
                    },
                },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
                    ...
                    // rSceneJudge
                    {
                        ...
                        -230,    //face_raw_xr_r_hm for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        -280,    //face_raw_xr_l_hm for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        -399,    //face_raw_xr_r_ml for Indoor Mid CT & Low CT dynamic, Unit = 1000
                        -499,    //face_raw_xr_l_ml for Indoor Mid CT & Low CT dynamic, Unit = 1000
                        -413,    //face_raw_yr_u for Indoor Greenish CT dynamic, Unit = 1000
                        -463     //face_raw_yr_d for Indoor Greenish CT dynamic, Unit = 1000
                    },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
                    ...
                    //rRefTarget - Reference Target Setting
                    {
                        ...
                        // i4RefTargetThr
                        {
                            ...
                            {{-687, -359}, {-687, -359}, {-687, -359}},  // HORIZON
                            {{-543, -371}, {-543, -371}, {-543, -371}},  // A
                            {{-374, -411}, {-374, -411}, {-374, -411}},  // TL84
                            {{-339, -476}, {-339, -476}, {-339, -476}},  // CWF
                            {{-200, -374}, {-200, -374}, {-200, -374}},  // DNP
                            {{-112, -371}, {-112, -371}, {-112, -371}},  // D65
                            {{-124, -445}, {-124, -445}, {-124, -445}},  // DF
                        },
                    },
