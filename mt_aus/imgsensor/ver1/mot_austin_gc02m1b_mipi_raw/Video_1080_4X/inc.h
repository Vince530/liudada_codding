 ...
 ************************************************************************************************/
#ifndef _VIDEO_1080_4X_H
#define _VIDEO_1080_4X_H
...
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0221)
...
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0182)
...
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0234)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0195)
#define EE_ISP_DSDN_BASE                                             M_CONC(TARGET_SENSOR, EE_0195)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0286)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0039)
#define MSYUV_ISP_DSDN_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0104)
