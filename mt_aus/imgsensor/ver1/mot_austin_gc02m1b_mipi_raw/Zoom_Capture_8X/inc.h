 ...
 ************************************************************************************************/
#ifndef _ZOOM_CAPTURE_8X_H
#define _ZOOM_CAPTURE_8X_H
...
#define DM_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, DM_0377)
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0663)
...
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0871)
...
#define DM_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, DM_0390)
#define YNR_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0689)
#define CNR_CNR_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0559)
#define EE_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0611)
#define LDNR_ISP_MFNR_BASE                                           M_CONC(TARGET_SENSOR, LDNR_0325)
...
#define MSYUV_ISP_MFNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0312)
#define OMC_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, OMC_0065)
#define YNR_ISP_MSNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0676)
#define EE_ISP_MSNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0598)
#define MSYUV_ISP_MSNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0299)
#define MSNR_THRES_ISP_MSNR_BASE                                     M_CONC(TARGET_SENSOR, MSNR_THRES_0008)
