...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                    ...
                    -286, // TUNGSTEN UpperBound
                    -386  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                    -232, // WARM FLUORESCENT RightBound
                    -676, // WARM FLUORESCENT LeftBound
                    -386, // WARM FLUORESCENT UpperBound
                    -578  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                      -9, // FLUORESCENT RightBound
    ...
    /******************************************************************************/
            // Preference gain for each light source
            {
                ...
                { // WARM FLUORESCENT
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {502, 512, 522}, {502, 512, 522}, {502, 512, 522}, {502, 512, 522},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {502, 512, 522}, {502, 512, 522}, {502, 512, 522}, {502, 512, 522}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                },
                { // FLUORESCENT
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
    ...
    /******************************************************************************/
            // AWB Light source probability (P1) look-up table (Max: 100; Min: 0)
            {
                ...
                {{  50,  50,  50,  50,  50,  50,  50,  50,  50,  50,  80,  80,  80,  80,  80,  80,  60,  30,   1,   1,   1,   1,   1}}, // TUNGSTEN
                {{  50,  50,  50,  50,  50,  50,  50,  50,  50,  50,  80,  80,  80,  80,  80,  80,  60,  30,   1,   1,   1,   1,   1}}, // WARM FLUORESCENT
                {{  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  95,  95,  95,  95,  95,  95,  80,  60,  60,  60,  60,  60,  60}}, // FLUORESCENT
