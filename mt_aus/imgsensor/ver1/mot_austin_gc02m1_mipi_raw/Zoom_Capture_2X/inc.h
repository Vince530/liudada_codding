 ...
 ************************************************************************************************/
#ifndef _ZOOM_CAPTURE_2X_H
#define _ZOOM_CAPTURE_2X_H
...
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0507)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0845)
...
#define DM_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, DM_0338)
#define YNR_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0585)
#define CNR_CNR_ISP_MFNR_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0481)
#define EE_ISP_MFNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0533)
#define LDNR_ISP_MFNR_BASE                                           M_CONC(TARGET_SENSOR, LDNR_0299)
...
#define AKS_ISP_MFNR_BASE                                            M_CONC(TARGET_SENSOR, AKS_0325)
...
#define YNR_ISP_MSNR_BASE                                            M_CONC(TARGET_SENSOR, YNR_0572)
#define EE_ISP_MSNR_BASE                                             M_CONC(TARGET_SENSOR, EE_0520)
#define MSYUV_ISP_MSNR_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0247)
#define MSNR_THRES_ISP_MSNR_BASE                                     M_CONC(TARGET_SENSOR, MSNR_THRES_0006)
