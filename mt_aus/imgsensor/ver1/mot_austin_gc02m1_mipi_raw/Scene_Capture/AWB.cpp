...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB gain of AWB light source
            {
                ...
                // HORIZON
                {
                     560, // AWBGAIN_HORIZON_R
                     512, // AWBGAIN_HORIZON_G
                    1214  // AWBGAIN_HORIZON_B
                },
                // A
                {
                     570, // AWBGAIN_A_R
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                    -232, // TUNGSTEN RightBound
                    -676, // TUNGSTEN LeftBound
                    -221, // TUNGSTEN UpperBound
                    -350  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                    -232, // WARM FLUORESCENT RightBound
                    -676, // WARM FLUORESCENT LeftBound
                    -350, // WARM FLUORESCENT UpperBound
                    -578  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                      -80, // FLUORESCENT RightBound
                    -232, // FLUORESCENT LeftBound
                    -283, // FLUORESCENT UpperBound
                    -462  // FLUORESCENT LowerBound
                },
                // CWF
                {
                      -6, // CWF RightBound
                ...
                // DAYLIGHT
                {
                     155, // DAYLIGHT RightBound
                      -75, // DAYLIGHT LeftBound
                    -283, // DAYLIGHT UpperBound
                    -450  // DAYLIGHT LowerBound
                },
                // SHADE
                {
                     253, // SHADE RightBound
                     155, // SHADE LeftBound
                    -283, // SHADE UpperBound
                    -393  // SHADE LowerBound
                },
                // DF
                {
                     155, // DF RightBound
    ...
    /******************************************************************************/
            ...
            // PWB light area
            {
                // DAYLIGHT
                {
                     180, // DAYLIGHT RightBound
                      -9, // DAYLIGHT LeftBound
                    -283, // DAYLIGHT UpperBound
                    -421  // DAYLIGHT LowerBound
                },
                // CLOUDY_D
                {
                     280, // CLOUDY_D RightBound
                     105, // CLOUDY_D LeftBound
                    -283, // CLOUDY_D UpperBound
                    -421  // CLOUDY_D LowerBound
                },
                // SHADE
                {
                     380, // SHADE RightBound
                     105, // SHADE LeftBound
                    -283, // SHADE UpperBound
                ...
                // TWILIGHT
                {
                      -9, // TWILIGHT RightBound
                    -169, // TWILIGHT LeftBound
                    -283, // TWILIGHT UpperBound
                    -421  // TWILIGHT LowerBound
                },
                // FLUORESCENT
                {
                     175, // FLUORESCENT RightBound
                    -253, // FLUORESCENT LeftBound
                    -313, // FLUORESCENT UpperBound
                    -488  // FLUORESCENT LowerBound
                },
                // WARM FLUORESCENT
                {
                    -176, // WARM FLUORESCENT RightBound
                    -376, // WARM FLUORESCENT LeftBound
                    -313, // WARM FLUORESCENT UpperBound
                    -488  // WARM FLUORESCENT LowerBound
                },
                // INCANDESCENT
                {
                    -176, // INCANDESCENT RightBound
                    -376, // INCANDESCENT LeftBound
                    -283, // INCANDESCENT UpperBound
    ...
    /******************************************************************************/
            // PWB default gain
            {
                ...
                // FLUORESCENT
                {
                     831, // PWB_FLUORESCENT_R
                     512, // PWB_FLUORESCENT_G
                     932  // PWB_FLUORESCENT_B
                },
                // WARM FLUORESCENT
                {
                     602, // PWB_WARM FLUORESCENT_R
                     512, // PWB_WARM FLUORESCENT_G
                    1281  // PWB_WARM FLUORESCENT_B
                },
                // INCANDESCENT
                {
                     564, // PWB_INCANDESCENT_R
    ...
    /******************************************************************************/
                ...
                {
                    -401,  // RotatedXCoordinate0
                    -401,  // RotatedXCoordinate1
                    -278,  // RotatedXCoordinate2
                     -64,  // RotatedXCoordinate3
    ...
    /******************************************************************************/
            // Preference gain for each light source
            {
                ...
                { // TUNGSTEN
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {488, 512, 512}, {488, 512, 512}, {488, 512, 512}, {512, 512, 512}, {508, 512, 512}, {506, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {518, 512, 508}, {518, 512, 508}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                },
                { // WARM FLUORESCENT
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {502, 512, 522}, {502, 512, 522}, {512, 512, 506}, {512, 512, 506},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {512, 512, 506}, {512, 512, 512}, {500, 512, 522}, {522, 512, 512}, {522, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                },
                { // FLUORESCENT
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {518, 512, 510}, {518, 512, 510},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {518, 512, 510}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                },
                { // CWF
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512},
                ...
                { // DAYLIGHT
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {500, 512, 512}, {500, 512, 512},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                },
                { // SHADE
    ...
    /******************************************************************************/
                // Sunset Prop
                {
                    ...
                    {
                         10, // i4Sunset_BoundXr_Thr//114
                        -327, // i4Sunset_BoundYr_Thr
                    },
                },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
            // AWB daylight locus probability (Statistic Weighting) look-up table (Max: 100; Min: 0)
            {
                ...
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  95,  75,  50,  40,  30,  30,   0,   0,   0}}, // FLUORESCENT
                {{  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  80,  55,  30,  30,  30,  30,   0,   0,   0}}, // CWF
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  70,  60,  40,  30,  20}}, // DAYLIGHT
    ...
    /******************************************************************************/
            // AWB Light source probability (P1) look-up table (Max: 100; Min: 0)
            {
                ...
                {{  50,  50,  50,  50,  50,  50,  50,  50,  50,  50,  80,  80,  80,  80,  60,  60,  20,  10,   1,   1,   1,   1,   1}}, // WARM FLUORESCENT
                {{  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  95,  95,  95,  95,  95,  85,  30,  20,  20,  20,  20,   1,   1}}, // FLUORESCENT
                {{  80,  80,  80,  80,  80,  80,  80,  80,  80,  80,  90,  90,  90,  90,  90,  90,  40,  20,   1,   1,   1,   1,   1}}, // CWF
    ...
    /******************************************************************************/
                    ...
                    // rSceneJudge
                    {
                        ...
                        -194,    //face_raw_xr_r_hm for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        -244,    //face_raw_xr_l_hm for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        -276,    //face_raw_xr_r_ml for Indoor Mid CT & Low CT dynamic, Unit = 1000
                        -376,    //face_raw_xr_l_ml for Indoor Mid CT & Low CT dynamic, Unit = 1000
                        -334,    //face_raw_yr_u for Indoor Greenish CT dynamic, Unit = 1000
                        -384     //face_raw_yr_d for Indoor Greenish CT dynamic, Unit = 1000
                    },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
                    ...
                    //rRefTarget - Reference Target Setting
                    {
                        ...
                        // i4RefTargetThr
                        {
                            ...
                            {{-468, -289}, {-468, -289}, {-468, -289}},  // HORIZON
                            {{-468, -289}, {-468, -289}, {-468, -289}},  // A
                            {{-357, -336}, {-357, -336}, {-357, -336}},  // TL84
                            {{-292, -393}, {-292, -393}, {-292, -393}},  // CWF
                            {{-130, -262}, {-130, -262}, {-130, -262}},  // DNP
                            {{ -66, -288}, { -66, -288}, { -66, -288}},  // D65
                            {{ -74, -362}, { -74, -362}, { -74, -362}},  // DF
                        },
                    },
                ...
                {
                    1,    //enable
                    {0, 24, 24, 24, 24, 24, 24, 24},  //i4StatWinShrinkOffset
                    0,    //Reserved1
                    0,    //Reserved2
                    0,    //Reserved3
                    0,    //Reserved4
