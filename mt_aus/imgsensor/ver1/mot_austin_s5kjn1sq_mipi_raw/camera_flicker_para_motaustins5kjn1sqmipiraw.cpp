//[Sensor]
//name = motaustins5kjn1sqmipiraw
//bin_ratio = 1,2
//
//[Preview]
//read_freq = 1144000000
//pixel_line = 10656
//column_length = 2423
//
//[Capture]
...
//column_length = 4903
//
#define LOG_TAG "motaustins5kjn1sqmipiraw"
...
static void get_flicker_para_by_Preview_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L60 = {976, 476, 889, -428};
    FLICKER_CUST_STATISTICS EV60_L50 = {1210, 482, 1274, -493};
...
static void get_flicker_para_by_Preview_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 80, 100, 120, 130, 160, 170, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {954, 487, 909, -434};
    FLICKER_CUST_STATISTICS EV60_L50 = {1142, 511, 1349, -507};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1479;
...
static void get_flicker_para_by_Video2_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {1349, 432, 1142, -465};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1379;
...
static void get_flicker_para_by_Video2_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 80, 100, 120, 130, 160, 170, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {990, 469, 877, -425};
    FLICKER_CUST_STATISTICS EV60_L50 = {1255, 465, 1228, -483};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1593;
...
static void get_flicker_para_by_Custom3_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {1290, 452, 1195, -476};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1378;
    para->flickerSearchRange = 40;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
