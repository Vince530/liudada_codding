...
#include "camera_AE_PLineTable_motaustins5kjn1sqmipiraw.h"
#include "camera_AE_Sync_param_motaustins5kjn1sqmipiraw.h"
#include "camera_AWB_Sync_param_motaustins5kjn1sqmipiraw.h"
#include "camera_AWB_Stat_param_motaustins5kjn1sqmipiraw.h"
#include "camera_info_motaustins5kjn1sqmipiraw.h"
...
#include "motaustins5kjn1sqmipiraw_Info.h"
...
#include INCLUDE_FILENAME_ISP_TONEMAP_PARAM
    ...
    DngMetadata:
    {
        ...
        3,  //i4RefereceIlluminant2
        {
            // rNoiseProfile[4]
            {
                {3.487593333088127e-07, 1.0644106490442171e-05},
                {7.46393616420174e-12, 2.458454893145799e-07},
            },
            {
                {3.5379524396702184e-07, 1.3275747087910772e-05},
                {7.693174732255215e-12, 1.456042840537609e-07},
            },
            {
                {3.55410339836229e-07, 1.0693583781070718e-05},
                {8.910756201626365e-12, 1.35144726782658e-07},
            },
            {
                {3.532469698057208e-07, 1.574679706496627e-05},
                {8.36333759867917e-12, 1.9405777520599633e-07},
            },
        },
    }
}};
