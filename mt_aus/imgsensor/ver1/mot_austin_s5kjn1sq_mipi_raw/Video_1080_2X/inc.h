 ...
 ************************************************************************************************/
#ifndef _VIDEO_1080_2X_H
#define _VIDEO_1080_2X_H
...
#define YNR_ISP_DSDN_BASE                                            M_CONC(TARGET_SENSOR, YNR_0208)
#define CNR_CNR_ISP_DSDN_BASE                                        M_CONC(TARGET_SENSOR, CNR_CNR_0169)
#define EE_ISP_DSDN_BASE                                             M_CONC(TARGET_SENSOR, EE_0169)
#define NR3D_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, NR3D_0208)
#define DSDN_ISP_DSDN_BASE                                           M_CONC(TARGET_SENSOR, DSDN_0026)
#define MSYUV_ISP_DSDN_BASE                                          M_CONC(TARGET_SENSOR, MSYUV_0091)
