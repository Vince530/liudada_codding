...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB gain of AWB light source
            {
                ...
                // HORIZON
                {
                     ...
                     602, // AWBGAIN_HORIZON_G
                    1485  // AWBGAIN_HORIZON_B
                },
                // A
                {
                     529, // AWBGAIN_A_R
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                    -166, // TUNGSTEN RightBound
                    -574, // TUNGSTEN LeftBound
                    -240, // TUNGSTEN UpperBound
                    -365  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                    -166, // WARM FLUORESCENT RightBound
                    -759, // WARM FLUORESCENT LeftBound
                    -365, // WARM FLUORESCENT UpperBound
                    -542  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                     -50, // FLUORESCENT RightBound
                    -166, // FLUORESCENT LeftBound
                    -227, // FLUORESCENT UpperBound
                    -441  // FLUORESCENT LowerBound
                },
                // CWF
                {
                     -50, // CWF RightBound
                ...
                // DAYLIGHT
                {
                     158, // DAYLIGHT RightBound
                     -50, // DAYLIGHT LeftBound
                    -227, // DAYLIGHT UpperBound
                    -421  // DAYLIGHT LowerBound
                },
                // SHADE
                {
                     322, //488, // SHADE RightBound
                     158, // SHADE LeftBound
                    -227, // SHADE UpperBound
                    -325  // SHADE LowerBound
                },
                // DF
                {
                     158, // DF RightBound
    ...
    /******************************************************************************/
            ...
            // PWB light area
            {
                // DAYLIGHT
                {
                     ...
                     -83, // DAYLIGHT LeftBound
                    -227, // DAYLIGHT UpperBound
                    -421  // DAYLIGHT LowerBound
                },
                // CLOUDY_D
                {
                     283, // CLOUDY_D RightBound
                     108, // CLOUDY_D LeftBound
                    -227, // CLOUDY_D UpperBound
                    -421  // CLOUDY_D LowerBound
                },
                // SHADE
                {
                     ...
                     108, // SHADE LeftBound
                    -227, // SHADE UpperBound
                    -421  // SHADE LowerBound
                },
                // TWILIGHT
                {
                     -83, // TWILIGHT RightBound
                    -243, // TWILIGHT LeftBound
                    -227, // TWILIGHT UpperBound
                    -421  // TWILIGHT LowerBound
                },
                // FLUORESCENT
                {
                     178, // FLUORESCENT RightBound
                    -178, // FLUORESCENT LeftBound
                    -257, // FLUORESCENT UpperBound
                    -502  // FLUORESCENT LowerBound
                },
                // WARM FLUORESCENT
                {
                    -142, // WARM FLUORESCENT RightBound
                    -342, // WARM FLUORESCENT LeftBound
                    -257, // WARM FLUORESCENT UpperBound
                    -502  // WARM FLUORESCENT LowerBound
                },
                // INCANDESCENT
                {
                    -142, // INCANDESCENT RightBound
                    -342, // INCANDESCENT LeftBound
                    -227, // INCANDESCENT UpperBound
                    -421  // INCANDESCENT LowerBound
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
            // PWB default gain
            {
                ...
                // FLUORESCENT
                {
                     805, // PWB_FLUORESCENT_R
                     512, // PWB_FLUORESCENT_G
                     905  // PWB_FLUORESCENT_B
                },
                // WARM FLUORESCENT
                {
                     560, // PWB_WARM FLUORESCENT_R
                     512, // PWB_WARM FLUORESCENT_G
                    1208  // PWB_WARM FLUORESCENT_B
                },
                // INCANDESCENT
                {
                     524, // PWB_INCANDESCENT_R
                     512, // PWB_INCANDESCENT_G
                    1111  // PWB_INCANDESCENT_B
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
                ...
                {
                    -487,  // RotatedXCoordinate0
                    -370,  // RotatedXCoordinate1
                    -206,  // RotatedXCoordinate2
                    -214,  // RotatedXCoordinate3
    ...
    /******************************************************************************/
            // Preference gain for each light source
            {
                ...
                { // TUNGSTEN
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {516, 512, 508}, {518, 512, 508}, {516, 512, 508}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 509}, {512, 512, 506},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {512, 512, 509}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                },
                { // WARM FLUORESCENT
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {514, 512, 510},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                },
                { // FLUORESCENT
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {502, 512, 512}, {502, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {518, 512, 506},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {512, 512, 512}, {502, 512, 512}, {508, 512, 512}, {506, 512, 512}, {502, 512, 512}, {506, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                },
                { // CWF
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {510, 512, 510}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                },
                { // DAYLIGHT
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {502, 512, 512}, {502, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 506},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {512, 512, 506}, {510, 512, 512}, {508, 512, 502}, {510, 512, 512}, {508, 512, 512}, {508, 512, 514}, {508, 512, 516}, {508, 512, 516}, {508, 512, 512}, {512, 512, 512}, {512, 512, 512}
                },
                { // SHADE
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512},
    ...
    /******************************************************************************/
            // AWB daylight locus probability (Statistic Weighting) look-up table (Max: 100; Min: 0)
            {
                ...
                {{  90,  90,  90,  90,  90,  90,  90,  95,  95,  95,  85,  85,  85,  90, 100, 100, 100,  75,  50,  25,   0,   0,   0}}, // TUNGSTEN
                {{  95,  95,  95,  95,  95,  95,  95,  95,  95,  95, 100,  95,  95, 100, 100,  75,  50,  25,  25,  25,   0,   0,   0}}, // WARM FLUORESCENT
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  90,  90,  90,  90,  90,  75,  65,  50,  35,  25,   0,   0,   0}}, // FLUORESCENT
                {{  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  80,  55,  30,  30,  30,  30,   0,   0,   0}}, // CWF
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  70,  50,  40,  30,  20}}, // DAYLIGHT
    ...
    /******************************************************************************/
            // AWB Light source probability (P1) look-up table (Max: 100; Min: 0)
            {
                ...
                {{  50,  50,  50,  50,  50,  50,  50,  50,  50,  50,  80,  80,  80,  60,  40,  20,  10,  10,   1,   1,   1,   1,   1}}, // TUNGSTEN
                {{  50,  50,  50,  50,  50,  50,  50,  50,  50,  50,  80,  80,  80,  70,  50,  30,  10,  10,   1,   1,   1,   1,   1}}, // WARM FLUORESCENT
                {{  90,  90,  90,  90,  90,  90,  90,  90,  90,  90,  95,  95,  95,  95,  95,  85,  60,  30,  20,  1,  1,  1,  1}}, // FLUORESCENT
                {{  80,  80,  80,  80,  80,  80,  80,  80,  80,  80,  90,  90,  90,  90,  90,  90,  66,  30,   1,   1,   1,   1,   1}}, // CWF
                {{  90,  90,  90,  80,  80,  90, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100}}, // DAYLIGHT
                {{  60,  60,  60,  60,  60,  80,  80,  80,  80,  80,  90,  90,  90,  90,  90,  90,  90,  60,  60,  30,   1,   1,   1}}, // SHADE
                {{  80,  80,  80,  80,  80,  80,  80,  80,  80,  80,  90,  90,  90,  90,  90,  90,  60,  30,   1,   1,   1,   1,   1}}, // DF
            },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
                //Daylight locus offset LUTs
                {
                    { // TUNGSTEN
                        {   0,  500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000},
                        {   0,  250,  500,  750, 1000, 1250, 1300, 1350, 2000, 2700, 2778, 3200, 3222, 3444, 3667, 3889, 4111, 4333, 4556, 4778, 5000}
                    },
                    { // WARM FLUORESCENT
                        {   0,  500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000},
                        {   0,  400,  900, 1000, 1250, 1300, 1500, 1950, 2000, 2000, 2400, 3000, 3000, 3200, 3467, 3889, 4111, 4333, 4556, 4778, 5000}
                    },
                    { // SHADE
                        {   0,  500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000},
                        {   0,  300,  500, 1500, 2000, 2500, 3000, 4000, 4500, 4750, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000}
                    },
                },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
                //AWB Green/Magenta offset threshold
                {
                    ...
                    { // SHADE
                        ...
                        { // LUT: use daylight locus offset (0~10000) as index to get magenta offset threshold
                          //  0   500  1000  1500  2000  2500  3000  3500  4000  4500  5000  5500  6000  6500  7000  7500  8000  8500  9000  9500  10000
                            100,  100,  200,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100
                        },
                        { // LUT: use daylight locus offset (0~10000) as index to get green offset threshold
                          //  0   500  1000  1500  2000  2500  3000  3500  4000  4500  5000  5500  6000  6500  7000  7500  8000  8500  9000  9500  10000
                            100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100
    ...
    /******************************************************************************/
                // AWB light source weight LUT
                {
                    { // Tungsten
                        { // LUT: use magenta offset (0~1000) as index to get tungsten weight (x/256)
                          // 0   100  200  300  400  500  600  700  800  900 1000
                            256, 256, 256, 256, 256, 256, 256, 160,  96,  80,  32
                        },
                    ...
                    { // Warm Fluorescent
                        ...
                        { // LUT: use green offset (0~1000) as index to get tungsten weight (x/256)
                          //  0  200  400  600  800 1000 1200 1400 1600 1800 2000
                            256, 256, 192,  80,  64,  64,  48,  24,  16,  16,  16
                        },
                    },
                    { // Shade
                        { // LUT: use magenta offset (0~1000) as index to get tungsten weight (x/256)
                          //  0  100  200  300  400  500  600  700  800  900 1000
                            256, 256, 144,  80,  48,  32,  16,  16,  16,  16,  16
                        },
                        { // LUT: use green offset (0~1000) as index to get tungsten weight (x/256)
                          //  0  100  200  300  400  500  600  700  800  900 1000
                            256, 256, 192, 112,  32,  32,  16,  16,  16,  16,  16
                        },
                    },
                },
    /******************************************************************************/
    ...
    /******************************************************************************/
                    ...
                    // rSceneJudge
                    {
                        ...
                        -133,    //face_raw_xr_r_hm for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        -183,    //face_raw_xr_l_hm for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        -281,    //face_raw_xr_r_ml for Indoor Mid CT & Low CT dynamic, Unit = 1000
                        -381,    //face_raw_xr_l_ml for Indoor Mid CT & Low CT dynamic, Unit = 1000
                        -298,    //face_raw_yr_u for Indoor Greenish CT dynamic, Unit = 1000
                        -348     //face_raw_yr_d for Indoor Greenish CT dynamic, Unit = 1000
                    },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
                    ...
                    //rRefTarget - Reference Target Setting
                    {
                        ...
                        // i4RefTargetThr
                        {
                            ...
                            {{-551, -243}, {-551, -243}, {-551, -243}},  // HORIZON
                            {{-434, -260}, {-434, -260}, {-434, -260}},  // A
                            {{-282, -321}, {-282, -321}, {-282, -321}},  // TL84
                            {{-251, -407}, {-251, -407}, {-251, -407}},  // CWF
                            {{-277, -335}, {-277, -335}, {-277, -335}},  // DNP
                            {{ -63, -232}, { -63, -232}, { -63, -232}},  // D65
                            {{ -91, -368}, { -91, -368}, { -91, -368}},  // DF
                        },
                    },
                ...
                {
                    1,    //enable
                    {0, 15, 15, 15, 15, 15, 15, 15},  //i4StatWinShrinkOffset
                    0,    //Reserved1
                    0,    //Reserved2
                    0,    //Reserved3
                    0,    //Reserved4
