...
# Use project first
ifeq ($(wildcard $(MTK_PATH_CUSTOM)/hal/camera_af),)
...
#-----------------------------------------------------------
LOCAL_SRC_FILES += \
  af_assist_flow_custom.cpp \
  af_flow_custom.cpp \
  af_tuning_custom.cpp

LOCAL_HEADER_LIBRARIES += libutils_headers libhardware_headers libcutils_headers libcamera.customaf_headers
...
LOCAL_MODULE := libcamera.customaf
...
#-----------------------------------------------------------
LOCAL_MODULE := libcamera.customaf_headers
LOCAL_MODULE_OWNER := mtk
