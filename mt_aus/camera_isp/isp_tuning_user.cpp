...
//  EE
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MVOID IspTuningCustom::userSetting_EE(EIndex_Isp_Edge_T eIdx_Edge, ISP_NVRAM_EE_T &rEE){
	...
	MINT32	LOCK_EE_Y1		= rEE.glut_ctrl_1.bits.EE_GLUT_Y1;		// 0~1023
	MINT32	LOCK_EE_Y2		= rEE.glut_ctrl_2.bits.EE_GLUT_Y2;		// 0~1023
	MINT32	LOCK_EE_Y3		= rEE.glut_ctrl_3.bits.EE_GLUT_Y3;		// 0~1023
	MINT32	LOCK_EE_Y4		= rEE.glut_ctrl_4.bits.EE_GLUT_Y4;		// 0~1023
	MINT32	LOCK_EE_S5		= rEE.glut_ctrl_5.bits.EE_GLUT_S5;		// 0~255
	MINT32	LOCK_EE_CLIP	= rEE.clip_ctrl.bits.EE_RESP_CLIP;		// 0~255
	MINT32	LOCK_EE_TH_OV	= rEE.glut_ctrl_6.bits.EE_GLUT_TH_OVR;	// 0~255
	MINT32	LOCK_EE_TH_UN	= rEE.glut_ctrl_6.bits.EE_GLUT_TH_UND;	// 0~255
	MINT32	LOCK_EE_TH_MN	= rEE.glut_ctrl_6.bits.EE_GLUT_TH_MIN;	// 0~255
	...
	// USM_ED_S1
	MINT32	USM_ED_X1 = rEE.glut_ctrl_1.bits.EE_GLUT_X1;
	MINT32	USM_ED_S1;
	...
	// USM_ED_S2
	MINT32	USM_ED_X2 = rEE.glut_ctrl_2.bits.EE_GLUT_X2;
	MINT32	USM_ED_S2;
	...
	// USM_ED_S3
	MINT32	USM_ED_X3 = rEE.glut_ctrl_3.bits.EE_GLUT_X3;
	MINT32	USM_ED_S3;
	...
	// USM_ED_S4
	MINT32	USM_ED_X4 = rEE.glut_ctrl_4.bits.EE_GLUT_X4;
	MINT32	USM_ED_S4;
	...
	// Write back
	rEE.glut_ctrl_1.bits.EE_GLUT_Y1		= static_cast<MUINT32>(USM_ED_Y1);
	rEE.glut_ctrl_2.bits.EE_GLUT_Y2		= static_cast<MUINT32>(USM_ED_Y2);
	rEE.glut_ctrl_3.bits.EE_GLUT_Y3		= static_cast<MUINT32>(USM_ED_Y3);
	rEE.glut_ctrl_4.bits.EE_GLUT_Y4		= static_cast<MUINT32>(USM_ED_Y4);
	rEE.clip_ctrl.bits.EE_RESP_CLIP		= static_cast<MUINT32>(USM_CLIP);
	rEE.glut_ctrl_6.bits.EE_GLUT_TH_OVR	= static_cast<MUINT32>(USM_ED_TH_OVER);
	rEE.glut_ctrl_6.bits.EE_GLUT_TH_UND	= static_cast<MUINT32>(USM_ED_TH_UNDER);
	rEE.glut_ctrl_6.bits.EE_GLUT_TH_MIN	= static_cast<MUINT32>(USM_ED_TH_MIN);

	rEE.glut_ctrl_1.bits.EE_GLUT_S1	= (USM_ED_S1 >= 0) ? static_cast<MUINT32>(USM_ED_S1) : static_cast<MUINT32>(256 + USM_ED_S1);
	rEE.glut_ctrl_2.bits.EE_GLUT_S2	= (USM_ED_S2 >= 0) ? static_cast<MUINT32>(USM_ED_S2) : static_cast<MUINT32>(256 + USM_ED_S2);
	rEE.glut_ctrl_3.bits.EE_GLUT_S3	= (USM_ED_S3 >= 0) ? static_cast<MUINT32>(USM_ED_S3) : static_cast<MUINT32>(256 + USM_ED_S3);
	rEE.glut_ctrl_4.bits.EE_GLUT_S4	= (USM_ED_S4 >= 0) ? static_cast<MUINT32>(USM_ED_S4) : static_cast<MUINT32>(256 + USM_ED_S4);
	rEE.glut_ctrl_5.bits.EE_GLUT_S5	= (USM_ED_S5 >= 0) ? static_cast<MUINT32>(USM_ED_S5) : static_cast<MUINT32>(256 + USM_ED_S5);
...
MVOID
IspTuningCustom::userSetting_HSBC(
    IspUsrSelectLevel_T const &rIspUsrSelectLevel,
    ISP_NVRAM_G2CX_T &rG2CX
)
{
    ...
    // Write back: G2CX
    rG2CX.conv_0a.bits.G2CX_CNV_00 = (YR >= 0) ? static_cast<MUINT32>(YR) : static_cast<MUINT32>(2048 + YR);
    rG2CX.conv_0a.bits.G2CX_CNV_01 = (YG >= 0) ? static_cast<MUINT32>(YG) : static_cast<MUINT32>(2048 + YG);
    rG2CX.conv_0b.bits.G2CX_CNV_02 = (YB >= 0) ? static_cast<MUINT32>(YB) : static_cast<MUINT32>(2048 + YB);
    rG2CX.conv_0b.bits.G2CX_Y_OFST = (Y_OFFSET11 >= 0) ? static_cast<MUINT32>(Y_OFFSET11) : static_cast<MUINT32>(2048 + Y_OFFSET11);
    rG2CX.conv_1a.bits.G2CX_CNV_10 = (UR >= 0) ? static_cast<MUINT32>(UR) : static_cast<MUINT32>(2048 + UR);
    rG2CX.conv_1a.bits.G2CX_CNV_11 = (UG >= 0) ? static_cast<MUINT32>(UG) : static_cast<MUINT32>(2048 + UG);
    rG2CX.conv_1b.bits.G2CX_CNV_12 = (UB >= 0) ? static_cast<MUINT32>(UB) : static_cast<MUINT32>(2048 + UB);
    rG2CX.conv_1b.bits.G2CX_U_OFST = (U_OFFSET10 >= 0) ? static_cast<MUINT32>(U_OFFSET10) : static_cast<MUINT32>(1024 + U_OFFSET10);
    rG2CX.conv_2a.bits.G2CX_CNV_20 = (VR >= 0) ? static_cast<MUINT32>(VR) : static_cast<MUINT32>(2048 + VR);
    rG2CX.conv_2a.bits.G2CX_CNV_21 = (VG >= 0) ? static_cast<MUINT32>(VG) : static_cast<MUINT32>(2048 + VG);
    rG2CX.conv_2b.bits.G2CX_CNV_22 = (VB >= 0) ? static_cast<MUINT32>(VB) : static_cast<MUINT32>(2048 + VB);
    rG2CX.conv_2b.bits.G2CX_V_OFST = (V_OFFSET10 >= 0) ? static_cast<MUINT32>(V_OFFSET10) : static_cast<MUINT32>(1024 + V_OFFSET10);

    MY_LOG("rG2CX.conv_0a.bits.G2CX_CNV_00=0x%8x \n", rG2CX.conv_0a.bits.G2CX_CNV_00);
    MY_LOG("rG2CX.conv_0a.bits.G2CX_CNV_01=0x%8x \n", rG2CX.conv_0a.bits.G2CX_CNV_01);
    MY_LOG("rG2CX.conv_0b.bits.G2CX_CNV_02=0x%8x \n", rG2CX.conv_0b.bits.G2CX_CNV_02);
    MY_LOG("rG2CX.conv_0b.bits.G2CX_Y_OFST=0x%8x \n", rG2CX.conv_0b.bits.G2CX_Y_OFST);
    MY_LOG("rG2CX.conv_1a.bits.G2CX_CNV_10=0x%8x \n", rG2CX.conv_1a.bits.G2CX_CNV_10);
    MY_LOG("rG2CX.conv_1a.bits.G2CX_CNV_11=0x%8x \n", rG2CX.conv_1a.bits.G2CX_CNV_11);
    MY_LOG("rG2CX.conv_1b.bits.G2CX_CNV_12=0x%8x \n", rG2CX.conv_1b.bits.G2CX_CNV_12);
    MY_LOG("rG2CX.conv_1b.bits.G2CX_U_OFST=0x%8x \n", rG2CX.conv_1b.bits.G2CX_U_OFST);
    MY_LOG("rG2CX.conv_2a.bits.G2CX_CNV_20=0x%8x \n", rG2CX.conv_2a.bits.G2CX_CNV_20);
    MY_LOG("rG2CX.conv_2a.bits.G2CX_CNV_21=0x%8x \n", rG2CX.conv_2a.bits.G2CX_CNV_21);
    MY_LOG("rG2CX.conv_2b.bits.G2CX_CNV_22=0x%8x \n", rG2CX.conv_2b.bits.G2CX_CNV_22);
    MY_LOG("rG2CX.conv_2b.bits.G2CX_V_OFST=0x%8x \n", rG2CX.conv_2b.bits.G2CX_V_OFST);
...
IspTuningCustom::userSetting_EFFECT(
        ...
        IspUsrSelectLevel_T const& rIspUsrSelectLevel,
        ISP_NVRAM_G2CX_T& rG2CX
        ISP_NVRAM_G2CX_SHADE_T& rG2CX_SHADE,
        ISP_NVRAM_SE_T& rSE
)
{
    MDOUBLE H_param[] = {-40, 0, 40};               // rotate degree H of 360
    ...
    switch (eIdx_Effect) {
        ...
        case MTK_CONTROL_EFFECT_MODE_F1977 :        //                     MY_LOG("V=%v, Cb=%f, Cr=%f, V,Cb,Cr);
            ...
            MY_LOG("loadLomoFilterG2C[eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1].G2CX_SHADE_P0[%d] = 0x%8x \n", eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1, loadLomoFilterG2C[eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1].G2C_SHADE_P0);
            MY_LOG("loadLomoFilterG2C[eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1].G2CX_SHADE_P1[%d] = 0x%8x \n", eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1, loadLomoFilterG2C[eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1].G2C_SHADE_P1);
            MY_LOG("loadLomoFilterG2C[eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1].G2CX_SHADE_P2[%d] = 0x%8x \n", eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1, loadLomoFilterG2C[eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1].G2C_SHADE_P2);
            MY_LOG("LOMO_PARA_GET_SHADE(%d,%d)=0x%8x  \n",LOMO_PARA_G2CX_SHADE_con_1,eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1,LOMO_PARA_GET_SHADE(LOMO_PARA_G2CX_SHADE_con_1,eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1));
            MY_LOG("LOMO_PARA_GET_SHADE(%d,%d)=0x%8x  \n",LOMO_PARA_G2CX_SHADE_con_2,eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1,LOMO_PARA_GET_SHADE(LOMO_PARA_G2CX_SHADE_con_2,eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1));
            MY_LOG("LOMO_PARA_GET_SHADE(%d,%d)=0x%8x  \n",LOMO_PARA_G2CX_SHADE_con_3,eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1,LOMO_PARA_GET_SHADE(LOMO_PARA_G2CX_SHADE_con_3,eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1));
            MY_LOG("LOMO_PARA_GET_SHADE(%d,%d)=0x%8x  \n",LOMO_PARA_G2CX_SHADE_tar,eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1,LOMO_PARA_GET_SHADE(LOMO_PARA_G2CX_SHADE_tar,eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1));
            MY_LOG("LOMO_PARA_GET_SHADE(%d,%d)=0x%8x  \n",LOMO_PARA_G2CX_SHADE_sp,eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1,LOMO_PARA_GET_SHADE(LOMO_PARA_G2CX_SHADE_sp,eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1));
            // Write back: G2CX_SHARE
            for(i=0;i<LOMO_PARA_G2C_SHADE_NUM;i++)
            {
                MY_LOG("HW rG2CX_SHADE.set[%d] = 0x%8x\n",i,rG2CX_SHADE.set[i]);
                rG2CX_SHADE.set[i] = LOMO_PARA_GET_SHADE(i,eIdx_Effect-MTK_CONTROL_EFFECT_MODE_NASHVILLE+1);
                MY_LOG("Lomo rG2CX_SHADE.set[%d] = 0x%8x\n",i,rG2CX_SHADE.set[i]);
            }
        ...
        default:
         MY_LOG("No related to Lomo Effect");
            ...
            {
                MY_LOG("HW rG2CX_SHADE.set[%d] = 0x%8x\n",i,rG2CX_SHADE.set[i]);
                rG2CX_SHADE.set[i] = LOMO_PARA_GET_SHADE(i,MTK_CONTROL_EFFECT_MODE_OFF);
                MY_LOG("NON-Lomo rG2CX_SHADE.set[%d] = 0x%8x\n",i,rG2CX_SHADE.set[i]);
            }
         break;
        }
    ...
    // Write back: SE
    rSE.top_ctrl.bits.EE_OUT_EDGE_SEL = SE_EDGE;
    rSE.se_y_specl_ctrl.bits.EE_SE_YOUT_QBIT = SE_YOUT_QBIT;
    rSE.se_y_specl_ctrl.bits.EE_SE_COUT_QBIT = SE_COUT_QBIT;
    rSE.se_y_specl_ctrl.bits.EE_SE_CONST_Y_EN = SE_Y;
    rSE.se_y_specl_ctrl.bits.EE_SE_CONST_Y_VAL = SE_Y_CONST;
    rSE.se_edge_ctrl_2.bits.EE_SE_OIL_EN = SE_OILEN;
    rSE.se_y_specl_ctrl.bits.EE_SE_KNEE_SEL = SE_KNEESEL;
    rSE.se_edge_ctrl_1.bits.EE_SE_HORI_EDGE_GAIN_B = SE_EGAIN_HB;
    rSE.se_edge_ctrl_1.bits.EE_SE_HORI_EDGE_GAIN_A = SE_EGAIN_HA;
    rSE.se_y_specl_ctrl.bits.EE_SE_SPECL_HALF_MODE = SE_SPECIPONLY;
    rSE.se_y_specl_ctrl.bits.EE_SE_SPECL_GAIN = SE_SPECIGAIN;
    rSE.se_edge_ctrl_1.bits.EE_SE_VERT_EDGE_GAIN_B = SE_EGAIN_VB;
    rSE.se_edge_ctrl_1.bits.EE_SE_VERT_EDGE_GAIN_A = SE_EGAIN_VA;
    rSE.se_y_specl_ctrl.bits.EE_SE_SPECL_ABS = SE_SPECIABS;
    rSE.se_y_specl_ctrl.bits.EE_SE_SPECL_INV = SE_SPECIINV;
    rSE.se_core_ctrl_1.bits.EE_SE_CORE_HORI_X0 = SE_COREH;
    rSE.se_core_ctrl_2.bits.EE_SE_CORE_VERT_X0 = SE_E_TH1_V;
    rSE.se_edge_ctrl_2.bits.EE_SE_BOSS_IN_SEL = SE_EMBOSS1;
    rSE.se_edge_ctrl_2.bits.EE_SE_BOSS_GAIN_OFF = SE_EMBOSS2;
#if 0
    ...
    switch (eIdx_Effect) {
        ...
        case MTK_CONTROL_EFFECT_MODE_F1977 :
            for(idx=0; idx<CUSTOM_LOMO_GGM_GAIN_NUM;idx++)
            {
                ...
                rGGM.set[idx]=LomoFilterGGM[(MUINT32)eIdx_Effect-(MUINT32)MTK_CONTROL_EFFECT_MODE_NASHVILLE+1][idx];
